...
### The realtime API cost is the same across all three

Before the worked example, an important point about a cost that's easy to misattribute: **the LLM/realtime API charge.**
